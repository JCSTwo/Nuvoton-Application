...
#define BULK2_IN_EP_NUM     0x04
#define BULK2_OUT_EP_NUM    0x05
...
extern uint32_t gu32OutSize;
extern uint32_t gu32InSize;

/*-------------------------------------------------------------*/
void VCOM_Init(void);
void VCOM_ClassRequest(void);
void USBD_VendorRequest(void);
