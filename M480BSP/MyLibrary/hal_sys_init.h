...
// UART Monitor = UART1 RX + UART3 RX
__STATIC_INLINE void SYS_Init_UART13(void)
{
    /* Enable UART module clock */
    CLK->APBCLK0 |= (CLK_APBCLK0_UART1CKEN_Msk | CLK_APBCLK0_UART3CKEN_Msk);
    /* Select UART module clock source */
    ...
    SYS->GPE_MFPH = (SYS->GPE_MFPH & ~(SYS_GPE_MFPH_PE11MFP_Msk)) | SYS_GPE_MFPH_PE11MFP_UART3_RXD;
    // Enable UART_RXD pin pull up to solve floating issue
    GPIO_SETPUSEL(PB, 2, GPIO_PUSEL_PULL_UP);
    GPIO_SETPUSEL(PE, 11, GPIO_PUSEL_PULL_UP);
}
...
// RS485 = UART1 (RS232) + PE12 (GPIO_MODE_OUTPUT)
